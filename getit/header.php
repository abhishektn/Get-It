...
<body>
   ...
   <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="create_topic.php">Answer a Question</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
		...
		{
			echo ' <li><a href="#"> Hello  <b>' . htmlentities($_SESSION['user_name']) . '</b> Not you?</a></li><li><a href="signout.php"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>';
		}
		else
		{
